...
*Norsk utgave. Hovedsida er [README.md](../README.md) på engelsk.*
...
Commscribe er produsert av [Furo Engineering](https://furoengineering.com) og
er åpen kildekode under Apache-lisensen 2.0.
...
| Linux | `.AppImage` / `.deb` | |
| Project NOMAD / Docker | `ghcr.io/krfuro/commscribe:<versjon>` | Supply Depot → *Add a custom app*, se [NOMAD.md](NOMAD.md) |
...
Skal du bygge selv, se [BUILD.md](BUILD.md).
...
Grensesnittet er på engelsk som standard og kan byttes til norsk, svensk,
tysk, fransk eller spansk i veiviseren eller under Innstillinger → Generelt.
Hvert språk er én fil under `web/lang/`; en nøkkel som mangler faller tilbake
til engelsk, så en ny oversettelse kan legges inn litt etter litt. Menyen i
skrivebordsappen følger samme valg. Talespråket i opptakene er en egen
innstilling under Innstillinger → Tekst.
...
Apache-lisensen 2.0, se [LICENSE](../LICENSE). Commscribe er produsert av Furo
Engineering, og [NOTICE](../NOTICE)-fila med det opphavet skal følge med i
enhver videreformidling. Kontroller lokale regler for opptak av
radiokommunikasjon før bruk.
